...
<body class="link-sidebar">
        ...
        <aside class="left-sidebar with-vertical">
            <div><!-- ---------------------------------- -->
                ...
                <div class="brand-logo d-flex align-items-center justify-content-between">
                    <a href="<?= base_url(); ?>/main/index.html" class="text-nowrap logo-img">
                        <img src="<?= base_url(); ?>/pro/assets/images/logos/dark-logo.png" class="dark-logo" alt="Logo-Dark" width="180" />
                        <img src="<?= base_url(); ?>/pro/assets/images/logos/light-logo.png" class="light-logo" alt="Logo-light" width="180" />
                    </a>
                ...
                <div class="fixed-profile p-3 mx-4 mb-2 bg-secondary-subtle rounded mt-3">
                    <div class="hstack gap-3">
                        ...
                        <div class="john-title">
                            <h6 class="mb-0 fs-4 fw-semibold"><?= $nama_depan; ?></h6>
                            <span class="fs-2"><?= $session["uniid"]; ?></span>
                        </div>
                ...
                <div class="with-vertical"><!-- ---------------------------------- -->
                    ...
                    <nav class="navbar navbar-expand-lg p-0">
                        ...
                        <div class="d-block d-lg-none py-4">
                            <a href="<?= base_url(); ?>/main/index.html" class="text-nowrap logo-img">
                                <img src="<?= base_url(); ?>/pro/assets/images/logos/dark-logo.png" class="dark-logo" alt="Logo-Dark" />
                                <img src="<?= base_url(); ?>/pro/assets/images/logos/light-logo.png" class="light-logo" alt="Logo-light" />
                            </a>
                        </div>
                                                ...
                                                <div class="d-flex align-items-center py-9 mx-7 border-bottom">
                                                    ...
                                                    <div class="ms-3">
                                                        ...
                                                        <p class="mb-0 d-flex align-items-center gap-2">
                                                            <i class="ti ti-mail fs-4"></i> <?= $session["uniid"]; ?><?= $session["nama_jabatan"] == 'Mahasiswa' ? '@student.ums.ac.id' : '@ums.ac.id'; ?>
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="message-body">
                                                    <a href="<?= base_url(); ?>/main/page-user-profile.html" class="py-8 px-7 mt-8 d-flex align-items-center">
                    ...
                    <nav class="navbar navbar-expand-xl container-fluid p-0">
                        <ul class="navbar-nav align-items-center">
                            ...
                            <li class="nav-item d-none d-xl-block">
                                <a href="<?= base_url(); ?>/main/index.html" class="text-nowrap nav-link">
                        ...
                        <div class="d-block d-xl-none">
                            <a href="<?= base_url(); ?>/main/index.html" class="text-nowrap nav-link">
                                <img src="<?= base_url(); ?>/pro/assets/images/logos/dark-logo.png" width="180" alt="modernize-img" />
                            </a>
                        </div>
                        <a class="navbar-toggler nav-icon-hover-bg rounded-circle p-0 mx-0 border-0" href="javascript:void(0)" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
                            <span class="p-2">
                                        ...
                                        <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop1">
                                            <div class="profile-dropdown position-relative" data-simplebar>
                                                ...
                                                <div class="message-body">
                                                    ...
                                                    <a href="<?= base_url(); ?>/main/app-email.html" class="py-8 px-7 d-flex align-items-center">
                                                        <span class="d-flex align-items-center justify-content-center text-bg-light rounded-1 p-6">
                                                            <img src="<?= base_url(); ?>/pro/assets/images/svgs/icon-inbox.svg" alt="modernize-img" width="24" height="24" />
                                                        </span>
                                                        <div class="w-100 ps-3">
                                                    ...
                                                    <a href="<?= base_url(); ?>/main/app-notes.html" class="py-8 px-7 d-flex align-items-center">
                                                        <span class="d-flex align-items-center justify-content-center text-bg-light rounded-1 p-6">
                                                            <img src="<?= base_url(); ?>/pro/assets/images/svgs/icon-tasks.svg" alt="modernize-img" width="24" height="24" />
                                                        </span>
                                                        <div class="w-100 ps-3">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-6">
                                                                <div class="m-n4 unlimited-img">
                                                                    <img src="<?= base_url(); ?>/pro/assets/images/backgrounds/unlimited-bg.png" alt="modernize-img" class="w-100" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <a href="<?= base_url(); ?>/main/authentication-login.html" class="btn btn-outline-primary">Log Out</a>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                        ...
                        <ul id="sidebarnav">
                            ...
                            <li class="sidebar-item">
                                ...
                                <!-- <ul aria-expanded="false" class="collapse first-level">
                                    <li class="sidebar-item">
                                        <a href="<?= base_url(); ?>/main/index.html" class="sidebar-link">
                                            <i class="ti ti-aperture"></i>
                                            <span class="hide-menu">Modern</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-item">
                                        <a href="<?= base_url(); ?>/main/index2.html" class="sidebar-link">
                                            <i class="ti ti-shopping-cart"></i>
                                            <span class="hide-menu">eCommerce</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-item">
                                        <a href="<?= base_url(); ?>/main/index3.html" class="sidebar-link">
                                            <i class="ti ti-currency-dollar"></i>
                                            <span class="hide-menu">NFT</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-item">
                                        <a href="<?= base_url(); ?>/main/index4.html" class="sidebar-link">
                                            <i class="ti ti-cpu"></i>
                                            <span class="hide-menu">Crypto</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-item">
                                        <a href="<?= base_url(); ?>/main/index5.html" class="sidebar-link">
                                            <i class="ti ti-activity-heartbeat"></i>
                                            <span class="hide-menu">General</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-item">
                                        <a href="<?= base_url(); ?>/main/index6.html" class="sidebar-link">
        ...
        <!-- <div class="offcanvas offcanvas-end shopping-cart" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
            ...
            <div class="offcanvas-body h-100 px-4 pt-0" data-simplebar>
                ...
                <div class="align-bottom">
                    ...
                    <a href="<?= base_url(); ?>/main/eco-checkout.html" class="btn btn-outline-primary w-100">Go to shopping cart</a>
                </div>
            </div>
        </div> -->
    </div>
    ...
    <script src="<?= base_url(); ?>/pro/assets/js/theme/app.init.js"></script>
