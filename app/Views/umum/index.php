    ...
    <div class="card w-100">
      <div class="card-body">
        ...
        <div class="row mt-2">
          <div class="col-12">
            <p>Legend:
              <span class="badge rounded-3 fw-semibold" style="background-color: #ff9f00;">BAA</span>
              <span class="badge rounded-3 fw-semibold" style="background-color: #007bff;">BIP</span>
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-12">
        ...
        <div class="card overflow-hidden">
          <div class="card-body p-4">
            <h5 class="card-title mb-9 fw-semibold">Filter Agenda</h5>
            <div class="row align-items-center">
              <div class="col-12 mb-2">
                <select class="form-select">
                  <option value="1">Unit</option>
                  <option value="2">BAA</option>
                  <option value="3">BPP</option>
      ...
      <div class="card">
        <div class="card-body">
          <div class="row alig n-items-start">
            <div class="col-12">
              <h5 class="card-title mb-9 fw-semibold"> Pilih Tampilan </h5>
              <div class="col-12">
                <select class="form-select">
                  <option value="1">Month</option>
                  <option value="2">TimeGrid</option>
                </select>
              </div>
            </div>
            <!-- <div class="col-4">
...
<div class="row">
  <div class="col-lg-5 d-flex align-items-stretch">
    <div class="card w-100">
      <div class="card-body p-4">
        <div class="mb-4">
          <h5 class="card-title fw-semibold">Agenda yang Akan Datang</h5>
        </div>
        <ul class="timeline-widget mb-0 position-relative mb-n5">
          <li class="timeline-item d-flex position-relative overflow-hidden">
            <div class="timeline-time text-dark flex-shrink-0 text-end">23 Juli 2024</div>
            <div class="timeline-badge-wrap d-flex flex-column align-items-center">
              <span class="timeline-badge border-2 border border-primary flex-shrink-0 my-8"></span>
              <span class="timeline-badge-border d-block flex-shrink-0"></span>
            </div>
            <div class="timeline-desc fs-3 text-dark mt-n1">
              <span class="fw-semibold">Seminar Nasional Kewirausahaan</span>
              Fakultas Teknik
            </div>
          </li>
          <li class="timeline-item d-flex position-relative overflow-hidden">
  ...
  <div class="col-lg-7 d-flex align-items-stretch">
    <div class="card w-100">
      <div class="card-body p-4">
        <h5 class="card-title fw-semibold mb-4">Agenda Baru Ditambahkan</h5>
...
<script>
  function Calendar(type = "all", unit = "all", kategori = "all") {
