...
<head>
    ...
    <title>MyAgenda UMS - Login</title>
</head>
                ...
                <div class="row">
                    <div class="col-xl-7 col-xxl-8">
                        <a href="../main/index.html" class="text-nowrap logo-img d-block px-4 py-9 w-100">
                            <img src="<?= base_url(); ?>/pro/assets/images/logos/dark-logo.png" class="dark-logo" alt="Logo-Dark" width="150" />
                            <img src="<?= base_url(); ?>/pro/assets/images/logos/light-logo.png" class="light-logo" alt="Logo-light" width="150" />
                        </a>
                        <div class="d-none d-xl-flex align-items-center justify-content-center h-n80">
                            <img src="<?= base_url(); ?>/pro/assets/images/backgrounds/login-security.svg" alt="modernize-img" class="img-fluid" width="500">
                        </div>
                    </div>
                    <div class="col-xl-5 col-xxl-4">
                        <div class="authentication-login min-vh-100 bg-body row justify-content-center align-items-center p-4">
                            <div class="auth-max-width col-sm-8 col-md-6 col-xl-7 px-4">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <a class="btn text-dark border fw-normal d-flex align-items-center justify-content-center rounded-2 py-8" href="/cas-login" role="button">
                                            <img src="<?= base_url(); ?>/pro/assets/images/logos/favicon.png" alt="modernize-img" class="img-fluid me-2" width="18" height="18">
                                ...
                                <form action="<?= base_url('/manual-login') ?>" method="post">
                                    <div class="mb-3">
                                    ...
                                    <button type="submit" name="ovovuevue" class="btn btn-primary w-100 py-8 mb-4 rounded-2">Sign In</button>
                                </form>
                            </div>
                        </div>
                    </div>
